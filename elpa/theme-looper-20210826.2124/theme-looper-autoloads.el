;;; theme-looper-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Lets user select a theme from a list of favorite ones rendered using a completion interface." t nil)

(autoload 'theme-looper-select-theme-from-all "theme-looper" "\
Lets user select a theme from a list of all available themes rendered a completion interface." t nil)

(register-definition-prefixes "theme-looper" '("theme-looper-"))
